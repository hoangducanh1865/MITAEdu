...
export default function RegisterPage() {
  ...
  return (
    <div className="auth-page" style={{ minHeight: "100vh", background: "var(--bg-page)", display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div className="auth-card" style={{ background: "var(--bg-surface)", borderRadius: "20px", boxShadow: "var(--shadow-strong)", padding: "44px 48px", width: "480px" }}>
        ...
        {registeredEmail ? (
          ...
          <div style={{ textAlign: "center" }}>
            ...
            <p style={{ fontSize: "0.875rem", color: "var(--text-muted)", lineHeight: 1.65, marginBottom: "8px" }}>
              ...
              <strong style={{ color: "var(--blue)" }}>{registeredEmail}</strong>
            </p>
          ...
          <>
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
              ...
              <div>
                ...
                <div style={{ marginTop: "8px" }}>
                  <div style={{ height: "8px", borderRadius: "999px", background: "var(--bg-muted)", overflow: "hidden" }}>
                    <div
                      style={{
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", gap: "10px", marginTop: "6px", fontSize: "0.74rem", color: "var(--text-muted)" }}>
              ...
              {error && (
                <div style={{ background: "var(--blue-light)", border: "1px solid var(--blue)", borderRadius: "10px", padding: "10px 14px", fontSize: "0.875rem", color: "var(--blue-dark)" }}>
            ...
            <p style={{ textAlign: "center", marginTop: "20px", fontSize: "0.875rem", color: "var(--text-muted)" }}>
              Đã có tài khoản?{" "}
              <Link href="/login" prefetch={false} style={{ color: "var(--blue)", fontWeight: 600 }}>Đăng nhập</Link>
            </p>
          </>
        )}
      </div>

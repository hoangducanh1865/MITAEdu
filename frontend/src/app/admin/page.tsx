  ...
  return (
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(200px,1fr))", gap: "16px", marginBottom: "32px" }}>
        <StatCard icon="fas fa-book" label="Khóa học" value={courses.length} color="#d32f2f" loading={loading} />
            ...
            <tbody>
              {courses.map((c) => (
                <tr key={c.id} style={{ borderBottom: "1px solid #f5f5f5" }}>
                  ...
                  <Td><span style={{ background: "#fdf0f0", color: "#d32f2f", borderRadius: "6px", padding: "2px 8px", fontSize: "0.75rem", fontWeight: 700 }}>{c.category}</span></Td>
                  <Td>{c.teacher ?? "—"}</Td>

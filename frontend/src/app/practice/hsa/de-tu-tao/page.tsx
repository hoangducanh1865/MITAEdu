...
export default function HsaDeTuTaoPage() {
  ...
  useEffect(() => {
    Promise.all([
      api.get<ApiResponse<ExamPackage[]>>("/api/exam-packages?tag=HSA"),
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
        ...
        <div style={{ background: "#fff", border: "2px solid #f0d5d5", borderRadius: "16px", padding: "20px 24px" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "16px" }}>
            ...
            <Link href="/practice/history" style={{ fontSize: "0.8rem", color: "#2e7d32", fontWeight: 600 }}>
              Xem tất cả →
            </Link>
          </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
              {history.map((s) => (
                <div key={s.id} style={{
                  ...
                  padding: "12px 14px", borderRadius: "12px", background: "#f9fdf9",
                  border: "1.5px solid #e8f5e9",
                }}>
                  <i className="fas fa-file-alt" style={{ color: "#2e7d32", fontSize: "1rem" }} />
                  <div style={{ flex: 1 }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "24px" }}>
              <h2 style={{ fontFamily: "Nunito, sans-serif", fontWeight: 800, fontSize: "1.2rem", color: "#2e7d32" }}>
                <i className="fas fa-file-alt" style={{ marginRight: "10px" }} />Chọn đề HSA
              </h2>
            ...
            <div style={{ marginBottom: "20px" }}>
              ...
              <select
                ...
                style={{
                  ...
                  border: "2px solid #e8f5e9", fontSize: "0.875rem", color: "#2c2c2c",
                  background: "#f9fdf9", outline: "none",
                }}
              >
            ...
            <div style={{
              background: "#e8f5e9", borderRadius: "10px", padding: "12px 14px",
              fontSize: "0.82rem", color: "#1b5e20", marginBottom: "24px",
            }}>
            ...
            <div style={{ display: "flex", gap: "12px" }}>
              ...
              <button
                ...
                style={{
                  ...
                  background: !selectedExamId ? "#b0bec5" : "#2e7d32",

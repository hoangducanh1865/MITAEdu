-- ============================================================
-- V10: Seed "Khóa Nền Tảng - ĐGNL TP HCM 2027 (V-ACT)" course + 179 lessons
-- 8 subjects: Toán, Tiếng Việt, Tiếng Anh, Hóa, Sinh học, Sử, Địa, Lí
-- ============================================================

-- Add description column to lessons (H2 + PostgreSQL both support IF NOT EXISTS)
ALTER TABLE lessons ADD COLUMN IF NOT EXISTS description TEXT;

-- Insert HSA course if not already present
...
WHERE NOT EXISTS (SELECT 1 FROM courses WHERE slug = 'khoa-nen-tang-vact-2027');

-- Clear lessons for idempotent re-run
...
-- Link Toán Bài 1 to media_assets seeded in V6
UPDATE lessons SET
  video_media_id       = 'toan-vact-hsa-b1-video',
  pdf_media_id         = 'toan-vact-hsa-b1-pdf',
  handwritten_media_id = 'toan-vact-hsa-b1-handwritten'
